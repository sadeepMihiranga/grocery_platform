...
import lk.grocery.platform.entity.*;
...
import lk.grocery.platform.repository.*;
...
public class UserServiceImpl extends EntityValidator implements UserService, UserDetailsService {
    ...
    public List<UserDTO> getAllUsers() {
        ...
        userList.forEach(user -> {
            ...
            userDTO.setDisplayName(user.getParty().getPrtyFirstName()+" "+user.getParty().getPrtyLastName());
