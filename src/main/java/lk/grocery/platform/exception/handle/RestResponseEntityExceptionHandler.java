package lk.grocery.platform.exception.handle;
...
import static lk.grocery.platform.util.constant.ResponseMessageKeys.*;
import static lk.grocery.platform.util.constant.ResponseMessageKeys.KEY_CODE;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity handleOperationException() throws IOException {
        return handleException(new lk.grocery.platform.exception.DataIntegrityViolationException(), HttpStatus.INTERNAL_SERVER_ERROR);
    }
