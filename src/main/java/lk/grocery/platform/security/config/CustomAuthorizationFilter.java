...
import static lk.grocery.platform.util.constant.Constants.REQUEST_PARTY_CODE;
import static lk.grocery.platform.util.constant.Constants.REQUEST_BRANCHES;
