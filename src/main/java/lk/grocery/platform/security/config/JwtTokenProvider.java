package lk.grocery.platform.security.config;

import io.jsonwebtoken.*;
import lk.grocery.platform.dto.FunctionDTO;
import lk.grocery.platform.dto.PartyDTO;
import lk.grocery.platform.security.User;
...
import static lk.grocery.platform.security.JwtTokenUtil.*;
...
public class JwtTokenProvider {
    ...
    private String realm = "Grocery_platform-Web";

    //@Value("${security.jwt.client-id}")
    //private String clientId;
    private String clientId = "groceryplatformweb";
